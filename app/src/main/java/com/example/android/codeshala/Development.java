...
public class Development extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase1= FirebaseDatabase.getInstance().getReference().child("Web Development").child("Session Details");
        mDatabase1.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(Development.this,
        ...
        mDatabase2= FirebaseDatabase.getInstance().getReference().child("Web Development").child("Syllabus");
        ...
        mDatabase3= FirebaseDatabase.getInstance().getReference().child("NodeJs").child("Session Details");
        ...
        mDatabase4= FirebaseDatabase.getInstance().getReference().child("NodeJs").child("Syllabus");
        ...
        mDatabase5= FirebaseDatabase.getInstance().getReference().child("Android").child("Session Details");
        ...
        mDatabase6= FirebaseDatabase.getInstance().getReference().child("Android").child("Syllabus");
        ...
        mDatabase7= FirebaseDatabase.getInstance().getReference().child("Machine Learning").child("Session Details");
        ...
        mDatabase8= FirebaseDatabase.getInstance().getReference().child("Machine Learning").child("Syllabus");
        ...
        link.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myWebLink.setData(Uri.parse("https://docs.google.com/forms/d/e/1FAIpQLSdUEe6Zzf5NsIZz4Sug6nTVQMZmmyDrARuISXFuhGh4CnUcrw/viewform?usp=pp_url"));
